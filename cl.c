...
#endif
{
  ...
  {
  {
    ...
    if ( (LA(1)==PROCEDURE) ) {
      ...
      zzmatch(ENDPROCEDURE); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
    }
    else {
      if ( (LA(1)==FUNCTION) ) {
...
#endif
{
  ...
  zzMake0;
  {
  comp_exp(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
#endif
{
  ...
  zzMake0;
  {
  plus_exp(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
#endif
{
  ...
  zzMake0;
  {
  term_exp(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
  ...
  if ( (setwd3[LA(1)]&0x40) ) {
    ...
    if ( (LA(1)==IDENT) ) {
      ...
      if ( (LA(1)==INTCONST) ) {
        ...
        if ( (LA(1)==CERT) ) {
          zzmatch(CERT); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
        }
        else {
          if ( (LA(1)==FALS) ) {
            zzmatch(FALS); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
          }
          else {
            if ( (LA(1)==OPENPAR) ) {
              zzmatch(OPENPAR);  zzCONSUME;
